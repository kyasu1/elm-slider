		...
		switch (_p0.ctor) {
			...
			case 'OnTouchStart':
				return _elm_lang$core$Native_Utils.update(
					state,
					{
						touch: _elm_lang$core$Maybe$Just(_p0._0)
					});
			default:
				var _p2 = _p0._0;
				var _p1 = _p0._1;
				return A2(
					...
					A2(
						...
						function (s) {
							return (_elm_lang$core$Native_Utils.cmp(_p2.clientX - s.clientX, 100) > 0) ? _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									state,
									{
										current: A3(_elm_lang$core$Basics$clamp, 0, _p1 - 1, state.current - 1),
										touch: _elm_lang$core$Maybe$Nothing
									})) : ((_elm_lang$core$Native_Utils.cmp(_p2.clientX - s.clientX, -100) < 0) ? _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									state,
									{
										current: A3(_elm_lang$core$Basics$clamp, 0, _p1 - 1, state.current + 1),
										touch: _elm_lang$core$Maybe$Nothing
									})) : _elm_lang$core$Maybe$Just(state));
						},
						state.touch));
		}
	});
...
var _kyasu1$elm_slider$Slider$dots = F3(
	function (move, current, images) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-slider--dots'),
				_1: {ctor: '[]'}
			},
			A2(
...
var _kyasu1$elm_slider$Slider$view = F3(
	function (_p6, _p5, images) {
		...
		var _p8 = _p5;
		var _p9 = _p8.current;
		var nextDisabled = _elm_lang$core$Native_Utils.eq(
			_p9,
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-slider--view'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('elm-slider--outer'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('elm-slider--prev'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('elm-slider--next'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
